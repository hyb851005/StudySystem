...
public partial class Admin_BBSManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
             bool b = SystemMgr.BLL.Common.RunSqlBool("delete  from Topic  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Topic]  order  by addtime desc ";
