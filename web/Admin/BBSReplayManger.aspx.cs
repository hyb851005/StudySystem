...
public partial class Admin_BBSReplayManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
             bool b = SystemMgr.BLL.Common.RunSqlBool("delete  from Replay  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Replay]  ";
