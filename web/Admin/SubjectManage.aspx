<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubjectManage.aspx.cs" Inherits="Admin_QuestionManage" StyleSheetTheme="Default" %>
...
<body background="../App_Themes/Default/Images/l_b_bg.jpg" class="body">
	...
	<ucTitle:TitleUC ID="TitleUC1" runat="server" Title="试题库管理" />
							...
							<table class="Table" cellpadding="2" cellspacing="0" border="0">									
								<tr>
									...
									<td valign="middle"><asp:DropDownList ID="ddlSubject" runat="server" 
											SkinID="ddlSkin" Visible=false></asp:DropDownList></td>
								</tr>								
								<tr>
									...
									<td valign="middle">
										<asp:GridView ID="gvQuestion" runat="server" SkinID="GridViewSkin" 
											...
											<Columns>
												...
												<asp:TemplateField HeaderText="试题库名称" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="64%" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black">
													<ItemTemplate>
														<%# Eval("Name") %>
													</ItemTemplate>
												</asp:TemplateField>
												<asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black">
													<ItemTemplate>
														<%--<asp:ImageButton ID="ibtUpdate" runat="server" CommandName="edit" CommandArgument='<%# Eval("ID") %>' ImageUrl="~/App_Themes/Default/Images/edit.gif" />&nbsp;&nbsp;--%>
                                                        <asp:ImageButton ID="ibtDelete" runat="server" CommandName="del" CommandArgument='<%# Eval("ID") %>' ImageUrl="~/App_Themes/Default/Images/delete.gif" />
													</ItemTemplate>
												</asp:TemplateField>
											</Columns>
										</asp:GridView>
