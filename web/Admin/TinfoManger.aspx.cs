...
public partial class Admin_TinfoManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
             bool b = SystemMgr.BLL.Common.RunSqlBool("delete  from Users  where  id='" + ID + "'");
    ...
    { 
        ...
        string sql = "select  " + strTop + "  * from [Users]  where UserType='教师' and (UserName like '%" + keyword.Text.Trim() + "%' or XingMing like '%" + keyword.Text.Trim() + "%')";
 
        return SystemMgr.BLL.Common.GetDs(sql, "users"); 
