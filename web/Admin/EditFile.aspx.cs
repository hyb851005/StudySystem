...
public partial class Admin_EditFile : System.Web.UI.Page
{
    ...
    private void Get_Article()
    {
        ...
        SqlDataReader dr = SystemMgr.BLL.Common.GetDataReader("select * from FileInfo where id=" + id);
        dr.Read();
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        int id = int.Parse(Request.QueryString["id"].ToString());
         bool b = SystemMgr.BLL.Common.RunSqlBool("update FileInfo set TitleName='" + TextBox1.Text + "',FileDs='" + ArticleContent.Value + "',FilePath='" + pic.Text + "' ,Ename='" + newname + "',addtime=getdate() where id=" + id);
