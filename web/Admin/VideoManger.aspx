<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VideoManger.aspx.cs" Inherits="Admin_VideoManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                               <asp:TemplateField HeaderText="视频名称">
                                <ItemTemplate>
                                    <asp:Label ID="VideoName" runat="server" Text='<%# Bind("VideoName") %>' ></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="200px" />
                            </asp:TemplateField>
                
                            <asp:TemplateField HeaderText="播放视频">
                                <ItemTemplate>
                                    <a href='../Play.aspx?url=files/<%#Eval("VideoPath") %>' target="_blank">播放视频</a>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "EditVideo.aspx?id="+Eval("id") %>'
