<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddVideo.aspx.cs" ValidateRequest="false"
    EnableEventValidation="false" Inherits="Admin_AddVideo" %>
            ...
            <tr>
                ...
                <td style="height: 21px" class="td2" colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
                        ErrorMessage="请输入视频名称"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                    ...
                    <div style="padding: 5px; border: 1px dashed #ccc; clear: both;">
                        <div style="clear: both;">
                            <div style="float: left;">
                                请选择视频：
                                <input id="file1" runat="server" class="inputBox" style1="width: 141px" type="file" />
                            </div>
                            <div style="float: left; margin-left: 5px;">
                                <asp:Button ID="Button2" runat="server" CausesValidation="False" CssClass="formbutton"
                                    Height="22px" OnClick="Button1_Click" Text="上传视频" />
                            </div>
                            <div style="float: left; margin-left: 5px; color: #ff0000;">
                                <asp:Label ID="Label1" runat="server" Visible="False"></asp:Label>注：请上传SWF格式文件<input
