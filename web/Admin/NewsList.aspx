 ...
 <td height="26" >
  ...
  <td align="center" style="height: 22px">
     ...
     <asp:Label ID="Label4" runat="server" ForeColor="Red" Text=""></asp:Label></td>
        ...
        <tr>
            <td height="26">
                新闻公告类别：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                    Width="213px">
                </asp:DropDownList>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr align="right" bgcolor="#eef4ea">
               <td align="left" colspan="10" style="min-height:40px; padding:5px;" >
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="标题">
                                <ItemTemplate>
                                    <asp:Label ID="title" runat="server" Text='<%# Bind("name") %>' ></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="200px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="类别">
                                <ItemTemplate>
                                    <asp:Label ID="leibie" runat="server" Text='<%# Bind("TypeName") %>' ></asp:Label>
                                </ItemTemplate>
                   ...
                   <br />
                   &nbsp;&nbsp;&nbsp;&nbsp; 共 <asp:Label ID="lab_allcount" runat="server" ForeColor="red" Text="0"></asp:Label> 条数据记录
