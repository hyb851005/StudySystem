...
using System.IO;
public partial class Admin_FileManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
             bool b = SystemMgr.BLL.Common.RunSqlBool("delete  from FileInfo  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [FileInfo] where TitleName like '%" + keyword.Text.Trim() + "%'  order  by addtime desc";
