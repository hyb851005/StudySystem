<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BBSManger.aspx.cs" Inherits="Admin_BBSManger" %>
            ...
            <tr align="right" bgcolor="#eef4ea">
               <td align="left" colspan="10" style="min-height:40px; padding:5px;" >
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        OnRowDataBound="gvInfo_RowDataBound" OnRowDeleting="gvInfo_RowDeleting" PageSize="18"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="发布人">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="AddUser" runat="server" Text='<%# Bind("AddUser") %>' ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
