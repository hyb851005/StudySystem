<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateQuestion.aspx.cs" Inherits="Admin_UpdateQuestion" StyleSheetTheme="Default" %>
...
<body background="../App_Themes/Default/Images/l_b_bg.jpg" class="body">
	...
	<ucTitle:TitleUC ID="TitleUC1" runat="server" Title="修改考题" />
						...
						<td bgcolor="#FFFFFF">
							<table class="Table" cellpadding="2" cellspacing="0" border="0">									
                                ...
                                <tr>
									<td width="120" valign="middle" class="LeftTD" align="right">
										正确答案1:</td>
									<td valign="middle"><asp:DropDownList ID="ddlAnswer1" runat="server" SkinID="ddlSkin">
                                ...
                                <tr>
									<td width="120" valign="middle" class="LeftTD" align="right">
										正确答案2:</td>
									<td valign="middle"><asp:DropDownList ID="ddlAnswer2" runat="server" SkinID="ddlSkin">
                                ...
                                <tr>
									<td width="120" valign="middle" class="LeftTD" align="right">
										正确答案3:</td>
									<td valign="middle"><asp:DropDownList ID="ddlAnswer3" runat="server" SkinID="ddlSkin">
                                        <asp:ListItem>无</asp:ListItem>
										<asp:ListItem>A</asp:ListItem>
										<asp:ListItem>B</asp:ListItem>
										<asp:ListItem>C</asp:ListItem>
                                ...
                                <tr>
									<td width="120" valign="middle" class="LeftTD" align="right">
										正确答案4:</td>
									<td valign="middle"><asp:DropDownList ID="ddlAnswer4" runat="server" SkinID="ddlSkin">
                                        <asp:ListItem>无</asp:ListItem>
										<asp:ListItem>A</asp:ListItem>
										<asp:ListItem>B</asp:ListItem>
										<asp:ListItem>C</asp:ListItem>
