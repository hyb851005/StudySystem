<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileManger.aspx.cs" Inherits="Admin_FileManger" %>
            ...
            <tr align="right" bgcolor="#eef4ea">
               <td align="left" colspan="10" style="min-height:40px; padding:5px;" >
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                               <asp:TemplateField HeaderText="多媒体课件名称">
                                <ItemTemplate>
                                    <asp:Label ID="TitleName" runat="server" Text='<%# Bind("TitleName") %>' ></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                
                            <asp:TemplateField HeaderText="下载多媒体课件">
                                <ItemTemplate>
                                    <a href='../files/<%#Eval("FilePath") %>' target="_blank">下载多媒体课件</a>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "EditFile.aspx?id="+Eval("id") %>'
