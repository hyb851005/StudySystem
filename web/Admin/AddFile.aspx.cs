...
public partial class Admin_AddFile : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        string sql = "insert into FileInfo(TitleName,FileDs,FilePath,Ename,FileName,AddTime)values('" + TextBox1.Text.Trim() + "','" + ArticleContent.Value + "','" + pic.Text + "','" + newname + "','" + filename + "',getdate())";
