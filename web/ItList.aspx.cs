...
public partial class WenXianList : System.Web.UI.Page
{
    ...
    private void gvbind()
    {
        string sql = "select * from News  where TypeName='文献参考' " + (txtkey.Text.Trim() == "" ? "" : " and [name] like '%" + txtkey.Text.Trim() + "%'") + "  order by addtime desc";
