<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MMPwd.aspx.cs" Inherits="MMPwd" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="t_2">
        <a href="javascript:void(0);">用户中心 > 修改登录密码 </a>
    </div>
    <table cellpadding="2" align="center" class="registeInfo" width="300">
        <tr>
