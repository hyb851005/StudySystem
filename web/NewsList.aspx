<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="NewsList.aspx.cs" Inherits="NewsList" Title="Untitled Page" %>
        ...
        <tbody>
            <tr>
                <td align="left" bgcolor="#fbfbfb" class="middle_border_1 margin_middle1" style="width: 661px">
                    <div class="t_2">
                        <a href="javascript:void(0);">新闻公告</a></div>
                        ...
                        <ItemTemplate>
                            <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td align="center" height="30" style="border-bottom: 1px dashed #FF9966; width: 120px;
                                        text-align: center;">
