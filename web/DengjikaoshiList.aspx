<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DengjikaoshiList.aspx.cs" Inherits="DaGangList" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td align="left" bgcolor="#fbfbfb" class="middle_border_1 margin_middle1" style="width: 661px">
             <div class="t_2"><a href="javascript:void(0);">教学大纲</a></div>
                     ...
                     <table id="Table1" runat="server" border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" height="30" style="border-bottom:1px dashed #FF9966; width:120px; text-align:center;">
                                        <asp:Label ID="Label1" runat="server" Height="20px" Text='<%# DataBinder.Eval(Container, "DataItem.Addtime") %>'
