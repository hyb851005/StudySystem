<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="zuoyeInfo.aspx.cs" Inherits="zuoyeInfo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table id="Table1" align="center" border="0" bordercolordark="#ffffff" bordercolorlight="#ffcf00"
        ...
        <tr>
            ...
            上传教师：  <asp:Label ID="lab_Teacher" runat="server" ></asp:Label>  &nbsp;&nbsp;&nbsp;&nbsp;
            
              更新日期：  <asp:Label ID="Label1" runat="server" ></asp:Label>  &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">下载练习题</asp:LinkButton><input
