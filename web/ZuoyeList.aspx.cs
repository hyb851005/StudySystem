...
public partial class ZuoyeList : System.Web.UI.Page
{
    ...
    private void gvbind()
    {
        string sql = "select * from WorkInfo " + (txtkey.Text.Trim() == "" ? "" : " where TitleName like '%" + txtkey.Text.Trim() + "%'") + "  order by addtime desc";
