<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkManger.aspx.cs" Inherits="Teachter_WorkManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="教学名称">
                                <ItemTemplate>
                                 完成：  <asp:Label ID="FTitle" runat="server" Text='<%# Bind("FTitle") %>'></asp:Label>
                                </ItemTemplate>
