<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZYManger.aspx.cs" Inherits="Teachter_ZYManger" %>
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="left" colspan="10" style="min-height: 40px; padding: 5px;">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="教学名称">
                                <ItemTemplate>
                                    <asp:Label ID="TitleName" runat="server" Text='<%# Bind("TitleName") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="下载教学资料">
                                <ItemTemplate>
                                    <a href='../files/<%#Eval("FilePath") %>' target="_blank">下载教学资料</a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "EditZY.aspx?id="+Eval("id") %>'
