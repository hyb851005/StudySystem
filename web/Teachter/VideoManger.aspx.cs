...
public partial class Admin_VideoManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
             bool b = SystemMgr.BLL.Common.RunSqlBool("delete  from Video  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Video]";

        return SystemMgr.BLL.Common.GetDs(sql, "video"); 
    }
}
