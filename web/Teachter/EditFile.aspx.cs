...
public partial class Admin_EditFile : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        int id = int.Parse(Request.QueryString["id"].ToString());
         bool b = SystemMgr.BLL.Common.RunSqlBool("update FileInfo set TitleName='" + TextBox1.Text + "',FileDs='" + ArticleContent.Value + "',FilePath='" + pic.Text + "' ,Ename='" + newname + "' where id=" + id);
