<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditZY.aspx.cs" Inherits="Teachter_EditZY" %>
     ...
     修改教学</td>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            style="margin-top: 8px" width="98%">
              ...
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="请输入教学名称"></asp:RequiredFieldValidator>
              </td>
             ...
             <tr>
                 ...
                 <td align="left" class="td2" colspan="3" style="height: 21px">
                    ...
                    <div>
                   上传文件名：  <asp:TextBox ID="pic" runat="server" CssClass="inputBox" ReadOnly="True" ></asp:TextBox> 
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="pic"
                            ErrorMessage="请上传文件"></asp:RequiredFieldValidator>（注：上传浏览文件后自动生成文件名称，不需要填写此项）
